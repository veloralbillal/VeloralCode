import{c as Y,u as L,b as E,r as x,j as e,i as ge,ba as ne,R as we,as as oe,bb as ye,aQ as ie,bc as ve,bd as je,be as Ne,X as R,ae as V,a4 as se,t as ke,g as Ce,v as Se,an as Te,aA as Ee,P as $,aa as G,ac as Le,e as Q,ab as de,bf as ae,bg as Re,$ as P,A as W,w as z,bh as le,aO as Oe,aP as J,h as Pe,at as $e,ai as Me,B as Be,bi as De}from"./index-DpH5res7.js";import{H as M,f as B,s as Ie,a as Ae,b as Fe,r as He}from"./toolInteractionService-CkO_3Rca.js";import{A as ce}from"./arrow-left-LHcrmYrA.js";import{T as Ue}from"./tablet-D-4Go-xm.js";import{G as xe}from"./git-fork-C9UwRxNu.js";import{a as me,M as _e,b as Je,F as pe,C as re}from"./CodeViewer-D4oaTnQf.js";import{M as ue}from"./message-square-CetPCSY7.js";import{d as Ve}from"./creatorProfileService-D84w2UJd.js";import{S as O}from"./star-BTa5RZLX.js";import{L as q}from"./lock-BOec6gAF.js";import{U as We}from"./user-check-DONcYDk2.js";import{C as ze}from"./chevron-up-BMeyNeo9.js";import{T as qe}from"./trash-2-jP6XbELr.js";import{S as Ye}from"./send-CZSAp11A.js";import{L as Ge}from"./loader-circle-Dwi6YwxL.js";/**
 * @license lucide-react v0.546.0 - ISC
 *
 * This source code is licensed under the ISC license.
 * See the LICENSE file in the root directory of this source tree.
 */const Qe=[["path",{d:"M8 3H7a2 2 0 0 0-2 2v5a2 2 0 0 1-2 2 2 2 0 0 1 2 2v5c0 1.1.9 2 2 2h1",key:"ezmyqa"}],["path",{d:"M16 21h1a2 2 0 0 0 2-2v-5c0-1.1.9-2 2-2a2 2 0 0 1-2-2V5a2 2 0 0 0-2-2h-1",key:"e1hn23"}]],Ke=Y("braces",Qe);/**
 * @license lucide-react v0.546.0 - ISC
 *
 * This source code is licensed under the ISC license.
 * See the LICENSE file in the root directory of this source tree.
 */const Xe=[["rect",{width:"20",height:"14",x:"2",y:"3",rx:"2",key:"48i651"}],["line",{x1:"8",x2:"16",y1:"21",y2:"21",key:"1svkeh"}],["line",{x1:"12",x2:"12",y1:"17",y2:"21",key:"vw1qmm"}]],Ze=Y("monitor",Xe);/**
 * @license lucide-react v0.546.0 - ISC
 *
 * This source code is licensed under the ISC license.
 * See the LICENSE file in the root directory of this source tree.
 */const et=[["path",{d:"M20 13c0 5-3.5 7.5-7.66 8.95a1 1 0 0 1-.67-.01C7.5 20.5 4 18 4 13V6a1 1 0 0 1 1-1c2 0 4.5-1.2 6.24-2.72a1.17 1.17 0 0 1 1.52 0C14.51 3.81 17 5 19 5a1 1 0 0 1 1 1z",key:"oel41y"}],["path",{d:"m14.5 9.5-5 5",key:"17q4r4"}],["path",{d:"m9.5 9.5 5 5",key:"18nt4w"}]],tt=Y("shield-x",et),st=({item:t,deviceMode:a,isPremium:s,setDeviceMode:n,onBack:o,onReload:r,onToggleFullscreen:l,isFullscreen:i,onOpenInfo:m,onOpenCode:d,onShare:u,onOpenTip:c,onOpenRemix:b,onToggleConsole:h,consoleOpen:w,logCount:j,onToggleReviews:p,reviewsOpen:y})=>{const{currentUser:g}=L(),{showToast:N}=E(),[k,f]=x.useState(!1);x.useEffect(()=>{async function C(){if(g!=null&&g.uid&&t.id){const I=await ve(g.uid,t.id);f(I)}}C()},[g==null?void 0:g.uid,t.id]);const D=async()=>{if(!g){N("Please login first to bookmark","info"),window.location.hash="#/login";return}if(t.id)try{const C=await je(g.uid,{id:t.id,title:t.title,category:t.category,language:t.language});f(C),N(C?"Tool saved to your bookmarks!":"Removed from bookmarks","success")}catch{N("Failed to update bookmark","error")}};return e.jsxs("header",{className:"h-14 bg-slate-900 border-b border-slate-800 px-3 sm:px-4 flex items-center justify-between text-slate-200 z-40 select-none",children:[e.jsxs("div",{className:"flex items-center gap-2.5 sm:gap-3 min-w-0",children:[e.jsxs("button",{onClick:o,className:"flex items-center gap-1.5 px-2.5 py-1.5 rounded-xl bg-slate-800 hover:bg-slate-700 text-slate-200 text-xs font-bold border border-slate-700 transition shrink-0",title:"Back to all tools",children:[e.jsx(ce,{className:"w-4 h-4 text-indigo-400"}),e.jsx("span",{className:"hidden sm:inline",children:"Back"})]}),e.jsxs("div",{className:"flex items-center gap-2 min-w-0 truncate",children:[e.jsx("span",{className:"flex h-2.5 w-2.5 rounded-full bg-emerald-400 animate-pulse shrink-0"}),e.jsx("h1",{className:"text-xs sm:text-sm font-bold text-white truncate",title:t.title,children:t.title}),e.jsx("span",{className:"hidden md:inline-block text-[11px] px-2 py-0.5 rounded-md bg-indigo-950/80 text-indigo-300 font-medium border border-indigo-800/60 shrink-0",children:t.category})]})]}),e.jsxs("div",{className:"hidden lg:flex items-center bg-slate-800/90 p-0.5 rounded-xl border border-slate-700/80 text-slate-400",children:[e.jsxs("button",{onClick:()=>n("desktop"),title:"Desktop Resolution (100%)",className:`p-1.5 rounded-lg transition text-xs flex items-center gap-1 ${a==="desktop"?"bg-indigo-600 text-white font-bold":"hover:text-white"}`,children:[e.jsx(Ze,{className:"w-3.5 h-3.5"}),e.jsx("span",{children:"Desktop"})]}),e.jsxs("button",{onClick:()=>n("tablet"),title:"Tablet View (768px)",className:`p-1.5 rounded-lg transition text-xs flex items-center gap-1 ${a==="tablet"?"bg-indigo-600 text-white font-bold":"hover:text-white"}`,children:[e.jsx(Ue,{className:"w-3.5 h-3.5"}),e.jsx("span",{children:"Tablet"})]}),e.jsxs("button",{onClick:()=>n("mobile"),title:"Mobile View (375px)",className:`p-1.5 rounded-lg transition text-xs flex items-center gap-1 ${a==="mobile"?"bg-indigo-600 text-white font-bold":"hover:text-white"}`,children:[e.jsx(ge,{className:"w-3.5 h-3.5"}),e.jsx("span",{children:"Mobile"})]})]}),e.jsxs("div",{className:"flex items-center gap-1 sm:gap-1.5 overflow-x-auto no-scrollbar py-1 shrink-0 max-w-[65vw] sm:max-w-none",children:[e.jsxs("button",{onClick:c,className:"hidden md:flex items-center gap-1 px-2.5 py-1.5 rounded-xl bg-rose-500/10 hover:bg-rose-500/20 text-rose-300 border border-rose-500/30 text-xs font-semibold transition",title:"Tip & Support Creator",children:[e.jsx(M,{className:"w-3.5 h-3.5 fill-rose-500/30"}),e.jsx("span",{className:"hidden xl:inline",children:"Tip"})]}),e.jsxs("button",{onClick:b,className:"hidden lg:flex items-center gap-1 px-2.5 py-1.5 rounded-xl bg-cyan-500/10 hover:bg-cyan-500/20 text-cyan-300 border border-cyan-500/30 text-xs font-semibold transition",title:"Fork & Remix this Tool",children:[e.jsx(xe,{className:"w-3.5 h-3.5"}),e.jsx("span",{className:"hidden xl:inline",children:"Remix"})]}),e.jsxs("button",{onClick:h,className:`p-2 rounded-xl border transition flex items-center gap-1 ${w?"bg-emerald-600 text-white border-emerald-500":"bg-slate-800 hover:bg-slate-700 text-slate-300 border-slate-700"}`,title:"Toggle Debug Console",children:[e.jsx(ne,{className:"w-3.5 h-3.5"}),j>0&&e.jsx("span",{className:"text-[10px] font-bold",children:j})]}),e.jsx("button",{onClick:r,className:"p-2 rounded-xl bg-slate-800 hover:bg-slate-700 text-slate-300 border border-slate-700 transition",title:"Reload Tool Output",children:e.jsx(we,{className:"w-3.5 h-3.5 text-indigo-400"})}),e.jsxs("button",{onClick:d,className:`flex items-center gap-1 px-2 py-1.5 rounded-xl text-xs font-semibold border transition ${s?"bg-slate-800 hover:bg-slate-700 text-slate-200 border-slate-700":"bg-amber-500/10 hover:bg-amber-500/20 text-amber-300 border-amber-500/30"}`,title:s?"Inspect Source Code":"Source Code (Premium Feature)",children:[e.jsx(me,{className:"w-3.5 h-3.5 text-amber-400"}),e.jsx("span",{className:"hidden md:inline",children:"Code"}),!s&&e.jsx("span",{className:"text-[9px] bg-amber-500/20 text-amber-400 px-1 rounded",children:"PRO"})]}),e.jsx("button",{onClick:m,className:"p-2 rounded-xl bg-slate-800 hover:bg-slate-700 text-slate-300 border border-slate-700 transition",title:"Tool Details & Information",children:e.jsx(oe,{className:"w-3.5 h-3.5 text-sky-400"})}),p&&e.jsxs("button",{onClick:p,className:`p-2 rounded-xl border transition flex items-center gap-1 ${y?"bg-indigo-600 text-white border-indigo-500 shadow-sm shadow-indigo-600/30":"bg-slate-800 hover:bg-slate-700 text-slate-300 border-slate-700"}`,title:"Community Reviews & Ratings",children:[e.jsx(ue,{className:"w-3.5 h-3.5 text-indigo-400"}),t.averageRating&&e.jsxs("span",{className:"text-[10px] font-bold text-amber-300 hidden xl:inline",children:["★ ",t.averageRating]})]}),e.jsx("button",{onClick:D,className:`p-2 rounded-xl border transition ${k?"bg-amber-500 text-white border-amber-400 shadow-sm shadow-amber-500/30":"bg-slate-800 hover:bg-slate-700 text-slate-300 border-slate-700"}`,title:k?"Remove from bookmarks":"Bookmark this tool",children:e.jsx(ye,{className:`w-3.5 h-3.5 ${k?"fill-current":""}`})}),e.jsx("button",{onClick:u,className:"p-2 rounded-xl bg-slate-800 hover:bg-slate-700 text-slate-300 border border-slate-700 transition",title:"Share & Embed Widget",children:e.jsx(ie,{className:"w-3.5 h-3.5"})}),e.jsx("button",{onClick:l,className:"p-2 rounded-xl bg-indigo-600 hover:bg-indigo-500 text-white transition shadow-sm shadow-indigo-600/30",title:i?"Exit Fullscreen":"Open Full Screen",children:i?e.jsx(_e,{className:"w-3.5 h-3.5"}):e.jsx(Je,{className:"w-3.5 h-3.5"})})]})]})};function at(t="",a="",s="",n=""){const o=[],r=`${t} ${a} ${s} ${n}`.toLowerCase();(r.includes("eval(")||r.includes("window.eval("))&&o.push({type:"danger",message:"Dynamic Code Execution (eval)",detail:"Avoid using eval() as it can execute unverified code strings."}),(r.includes("document.cookie")||r.includes("window.cookie"))&&o.push({type:"danger",message:"Cookie Access Attempt",detail:"Script attempts to access browser cookies."}),(r.includes("window.location.replace")||r.includes("window.location.href ="))&&o.push({type:"warning",message:"Automatic Page Redirect",detail:"Script may forcefully redirect users away from the tool page."}),(r.includes("localstorage.clear()")||r.includes("sessionstorage.clear()"))&&o.push({type:"warning",message:"Storage Wipe Detected",detail:"Script contains calls to clear local storage."}),(r.includes("coinhive")||r.includes("cryptonight")||r.includes("minero"))&&o.push({type:"danger",message:"Crypto Mining Signature",detail:"Script matches known background cryptocurrency miner patterns."});let l=100;o.forEach(m=>{m.type==="danger"&&(l-=35),m.type==="warning"&&(l-=15),m.type==="info"&&(l-=5)}),l=Math.max(0,Math.min(100,l));let i="safe";return l<50?i="high":l<75?i="medium":l<95&&(i="low"),{isSafe:l>=70,score:l,riskLevel:i,flags:o}}const lt=({item:t,isOpen:a,onClose:s,onOpenCode:n,onNavigate:o,onOpenTip:r})=>{const[l,i]=x.useState(null);if(x.useEffect(()=>{a&&t.creatorUid?Ve(t.creatorUid).then(h=>{i(h)}):i(null)},[a,t.creatorUid]),!a)return null;const m=Ne(t.category),d=B((l==null?void 0:l.creatorName)||t.creatorName,t.creatorEmail,"Creator"),u=!!((l==null?void 0:l.isVerified)??t.creatorVerified??!1),c=at(t.html,t.css,t.js,t.code),b=c.riskLevel==="safe"||c.riskLevel==="low";return e.jsx("div",{className:"fixed inset-0 z-50 flex items-center justify-center p-4 bg-black/75 backdrop-blur-xs animate-in fade-in duration-150",children:e.jsxs("div",{className:"bg-slate-900 border border-slate-700/80 rounded-3xl max-w-lg w-full max-h-[90vh] overflow-y-auto p-6 text-slate-200 shadow-2xl space-y-5",children:[e.jsxs("div",{className:"flex items-start justify-between gap-3",children:[e.jsxs("div",{className:"space-y-1.5",children:[e.jsxs("div",{className:"flex items-center gap-2 flex-wrap",children:[e.jsx("span",{className:`text-[11px] font-semibold px-2.5 py-0.5 rounded-full border ${m}`,children:t.category}),e.jsx("span",{className:"text-[11px] font-mono px-2 py-0.5 rounded-md bg-slate-800 text-slate-300 border border-slate-700",children:t.language})]}),e.jsx("h3",{className:"text-lg font-bold text-white leading-snug",children:t.title})]}),e.jsx("button",{onClick:s,className:"p-1.5 rounded-xl bg-slate-800 hover:bg-slate-700 text-slate-400 hover:text-white transition",children:e.jsx(R,{className:"w-4 h-4"})})]}),e.jsxs("div",{className:"p-4 bg-slate-950/90 rounded-2xl border border-slate-800/90 flex flex-col sm:flex-row sm:items-center justify-between gap-3",children:[e.jsxs("div",{className:"flex items-center gap-3",children:[e.jsx("div",{className:"w-10 h-10 rounded-2xl bg-slate-800 text-slate-200 border border-slate-700 flex items-center justify-center font-bold text-xs shrink-0",children:d?d.slice(0,2).toUpperCase():e.jsx(V,{className:"w-4 h-4"})}),e.jsxs("div",{children:[e.jsx("p",{className:"text-xs font-bold text-slate-200",children:d}),e.jsx("div",{className:"mt-0.5",children:u?e.jsxs("span",{className:"inline-flex items-center gap-1 text-[10px] font-bold text-emerald-400 bg-emerald-950/80 px-2 py-0.5 rounded-full border border-emerald-800",children:[e.jsx(se,{className:"w-3 h-3 text-emerald-400"})," Verified Contributor"]}):e.jsxs("span",{className:"inline-flex items-center gap-1 text-[10px] font-medium text-slate-400 bg-slate-800/80 px-2 py-0.5 rounded-full border border-slate-700",children:[e.jsx(V,{className:"w-3 h-3 text-slate-400"})," Community Author"]})})]})]}),t.creatorUid&&o&&e.jsx("button",{onClick:()=>{s(),o(`#/creator/${t.creatorUid}`)},className:"text-[11px] text-emerald-400 hover:underline font-semibold self-start sm:self-auto",children:"View Creator Portfolio →"})]}),e.jsxs("div",{className:`p-4 rounded-2xl border space-y-2.5 ${b?"bg-emerald-950/30 border-emerald-800/50":c.riskLevel==="medium"?"bg-amber-950/30 border-amber-800/50":"bg-rose-950/30 border-rose-800/50"}`,children:[e.jsxs("div",{className:"flex items-center justify-between",children:[e.jsxs("div",{className:"flex items-center gap-2",children:[b?e.jsx(se,{className:"w-4 h-4 text-emerald-400"}):c.riskLevel==="medium"?e.jsx(Te,{className:"w-4 h-4 text-amber-400"}):e.jsx(tt,{className:"w-4 h-4 text-rose-400"}),e.jsx("span",{className:`text-xs font-bold ${b?"text-emerald-300":c.riskLevel==="medium"?"text-amber-300":"text-rose-300"}`,children:b?"Tool Safety Status: Safe":c.riskLevel==="medium"?"Tool Safety Status: Review Needed":"Tool Safety Status: High Risk"})]}),e.jsxs("span",{className:"text-[11px] font-mono font-bold px-2 py-0.5 rounded-md bg-black/40 text-slate-200",children:["Safety Score: ",c.score,"/100"]})]}),e.jsx("p",{className:"text-[11px] text-slate-300 leading-relaxed",children:b?"✓ No malicious code, cookies stealing, phishing scripts, or harmful redirects detected. This tool executes inside an isolated sandbox iframe environment.":c.flags.map(h=>h.message).join(". ")})]}),t.description?e.jsx("p",{className:"text-xs sm:text-sm text-slate-300 leading-relaxed bg-slate-950/60 p-3.5 rounded-2xl border border-slate-800",children:t.description}):e.jsx("p",{className:"text-xs text-slate-500 italic",children:"No description provided for this tool."}),t.tags&&t.tags.length>0&&e.jsxs("div",{className:"space-y-1.5",children:[e.jsx("span",{className:"text-[11px] font-semibold text-slate-400 uppercase tracking-wider",children:"Tags"}),e.jsx("div",{className:"flex flex-wrap gap-1.5",children:t.tags.map((h,w)=>e.jsxs("span",{className:"text-xs px-2.5 py-1 rounded-lg bg-slate-800 text-slate-300 border border-slate-700/60",children:["#",h]},w))})]}),e.jsxs("div",{className:"grid grid-cols-3 gap-2.5 pt-2 border-t border-slate-800 text-xs",children:[e.jsxs("div",{className:"p-3 bg-slate-950/60 rounded-xl border border-slate-800 space-y-1",children:[e.jsxs("span",{className:"text-slate-500 flex items-center gap-1 text-[10px]",children:[e.jsx(ke,{className:"w-3 h-3"})," Total Views"]}),e.jsx("span",{className:"font-bold text-white text-xs",children:t.views||0})]}),e.jsxs("div",{className:"p-3 bg-slate-950/60 rounded-xl border border-slate-800 space-y-1",children:[e.jsxs("span",{className:"text-slate-500 flex items-center gap-1 text-[10px]",children:[e.jsx(O,{className:"w-3 h-3 text-amber-400"})," Rating"]}),e.jsx("span",{className:"font-bold text-amber-400 text-xs",children:t.averageRating?`${t.averageRating} ★`:"New Tool"})]}),e.jsxs("div",{className:"p-3 bg-slate-950/60 rounded-xl border border-slate-800 space-y-1",children:[e.jsxs("span",{className:"text-slate-500 flex items-center gap-1 text-[10px]",children:[e.jsx(Ce,{className:"w-3 h-3"})," Date"]}),e.jsx("span",{className:"font-bold text-white text-xs",children:Se(t.updatedAt||t.createdAt)})]})]}),e.jsxs("div",{className:"flex items-center justify-between gap-3 pt-2 border-t border-slate-800",children:[e.jsxs("button",{onClick:()=>{s(),n()},className:"flex items-center gap-1.5 px-3.5 py-2 rounded-xl bg-slate-800 hover:bg-slate-700 text-slate-200 text-xs font-semibold border border-slate-700 transition",children:[e.jsx(pe,{className:"w-4 h-4 text-amber-400"}),e.jsx("span",{children:"Inspect Code"})]}),e.jsxs("div",{className:"flex items-center gap-2",children:[r&&e.jsxs("button",{onClick:()=>{s(),r()},className:"px-3.5 py-2 bg-rose-600 hover:bg-rose-500 text-white rounded-xl text-xs font-bold transition flex items-center gap-1 shadow-md shadow-rose-600/30",children:[e.jsx(M,{className:"w-3.5 h-3.5"}),e.jsx("span",{children:"Tip"})]}),e.jsx("button",{onClick:s,className:"px-4 py-2 bg-indigo-600 hover:bg-indigo-500 text-white rounded-xl text-xs font-bold transition shadow-md shadow-indigo-600/30",children:"Return to Tool"})]})]})]})})},rt=({codeId:t,creatorUid:a,creatorEmail:s,code:n,language:o,title:r,isOpen:l,isPremium:i,onClose:m,onOpenPremiumPrompt:d})=>{const{showToast:u}=E(),{currentUser:c}=L(),[b,h]=Ee.useState(!1);if(!l)return null;const w=async()=>{if(!i){d&&d();return}await de(n)&&(h(!0),u("Code copied to clipboard!","success"),setTimeout(()=>h(!1),2e3),t&&ae({codeId:t,toolTitle:r,creatorUid:a,creatorEmail:s,userUid:c==null?void 0:c.uid,userEmail:(c==null?void 0:c.email)||void 0,isPremium:i,actionType:"copy"}))},j=()=>{if(!i){d&&d();return}Re(n,r,o),u(`Downloaded ${r}`,"info"),t&&ae({codeId:t,toolTitle:r,creatorUid:a,creatorEmail:s,userUid:c==null?void 0:c.uid,userEmail:(c==null?void 0:c.email)||void 0,isPremium:i,actionType:"download"})};return e.jsx("div",{className:"fixed inset-0 z-50 flex items-center justify-center p-3 sm:p-6 bg-black/75 backdrop-blur-xs animate-in fade-in duration-150",children:e.jsxs("div",{className:"bg-slate-900 border border-slate-700 rounded-3xl max-w-4xl w-full max-h-[90vh] flex flex-col text-slate-200 shadow-2xl overflow-hidden",children:[e.jsxs("div",{className:"px-5 py-3.5 bg-slate-900 border-b border-slate-800 flex items-center justify-between flex-wrap gap-2",children:[e.jsxs("div",{className:"flex items-center gap-2",children:[e.jsx(pe,{className:"w-4 h-4 text-amber-400"}),e.jsxs("h3",{className:"text-sm font-bold text-white",children:["Source Code: ",r]}),e.jsx("span",{className:"text-[11px] px-2 py-0.5 rounded bg-indigo-950 text-indigo-300 font-mono border border-indigo-800",children:o}),!i&&e.jsxs("span",{className:"flex items-center gap-1 text-[10px] font-bold px-2 py-0.5 rounded-full bg-amber-500/10 text-amber-400 border border-amber-500/30",children:[e.jsx(q,{className:"w-2.5 h-2.5"})," Premium Only"]})]}),e.jsxs("div",{className:"flex items-center gap-2",children:[e.jsxs("button",{onClick:w,disabled:!i,className:"flex items-center gap-1.5 px-3 py-1.5 rounded-xl bg-slate-800 hover:bg-slate-700 text-slate-200 text-xs font-semibold border border-slate-700 transition disabled:opacity-40 disabled:cursor-not-allowed",title:i?"Copy source code":"Premium required to copy",children:[b?e.jsx($,{className:"w-3.5 h-3.5 text-emerald-400"}):e.jsx(G,{className:"w-3.5 h-3.5"}),e.jsx("span",{children:b?"Copied":"Copy"})]}),e.jsxs("button",{onClick:j,disabled:!i,className:"flex items-center gap-1.5 px-3 py-1.5 rounded-xl bg-slate-800 hover:bg-slate-700 text-slate-200 text-xs font-semibold border border-slate-700 transition disabled:opacity-40 disabled:cursor-not-allowed",title:i?"Download code file":"Premium required to download",children:[e.jsx(Le,{className:"w-3.5 h-3.5"}),e.jsx("span",{children:"Download"})]}),e.jsx("button",{onClick:m,className:"p-1.5 rounded-xl bg-slate-800 hover:bg-slate-700 text-slate-400 hover:text-white transition ml-1",children:e.jsx(R,{className:"w-4 h-4"})})]})]}),e.jsx("div",{className:"flex-1 overflow-auto p-4 bg-slate-950 relative",children:i?e.jsx(re,{code:n,language:o,title:r,showLineNumbers:!0,maxHeight:"60vh"}):e.jsxs("div",{className:"relative",children:[e.jsx("div",{className:"filter blur-md select-none pointer-events-none opacity-40",children:e.jsx(re,{code:n.slice(0,300)+`

// Protected content hidden for free tier...`,language:o,title:r,showLineNumbers:!0,maxHeight:"350px"})}),e.jsxs("div",{className:"absolute inset-0 flex flex-col items-center justify-center text-center p-6 bg-slate-950/80 backdrop-blur-xs rounded-2xl border border-slate-800 space-y-4",children:[e.jsx("div",{className:"w-12 h-12 rounded-2xl bg-amber-500/10 border border-amber-500/30 text-amber-400 flex items-center justify-center",children:e.jsx(q,{className:"w-6 h-6"})}),e.jsxs("div",{className:"space-y-1.5 max-w-sm",children:[e.jsx("h4",{className:"text-sm font-bold text-white",children:"Source Code is Locked for Free Tier"}),e.jsx("p",{className:"text-xs text-slate-400 leading-relaxed",children:"You have full access to run and use this tool live in full-screen. Source code download & copy access is reserved for Premium Members."})]}),d&&e.jsxs("button",{onClick:d,className:"flex items-center gap-2 px-4 py-2.5 bg-gradient-to-r from-amber-500 to-amber-600 hover:from-amber-400 hover:to-amber-500 text-slate-950 font-bold rounded-xl text-xs transition shadow-lg shadow-amber-500/20",children:[e.jsx(Q,{className:"w-4 h-4 fill-current"}),e.jsx("span",{children:"Learn How to Get Premium Access"})]})]})]})})]})})},nt=({isOpen:t,onClose:a,onNavigate:s})=>{const{currentUser:n,userProfile:o}=L();return t?e.jsx("div",{className:"fixed inset-0 z-50 flex items-center justify-center p-4 bg-black/80 backdrop-blur-xs animate-in fade-in duration-150",children:e.jsxs("div",{className:"bg-slate-900 border border-amber-500/30 rounded-3xl max-w-md w-full p-6 text-slate-200 shadow-2xl space-y-5 relative overflow-hidden",children:[e.jsx("div",{className:"absolute -top-20 -right-20 w-40 h-40 bg-amber-500/10 rounded-full blur-2xl pointer-events-none"}),e.jsx("div",{className:"absolute -bottom-20 -left-20 w-40 h-40 bg-indigo-500/10 rounded-full blur-2xl pointer-events-none"}),e.jsx("button",{onClick:a,className:"absolute top-4 right-4 p-1.5 rounded-xl bg-slate-800 hover:bg-slate-700 text-slate-400 hover:text-white transition",children:e.jsx(R,{className:"w-4 h-4"})}),e.jsxs("div",{className:"text-center space-y-2 pt-2",children:[e.jsx("div",{className:"w-14 h-14 rounded-2xl bg-amber-500/10 border border-amber-500/20 text-amber-400 flex items-center justify-center mx-auto shadow-lg shadow-amber-500/5",children:e.jsx(q,{className:"w-7 h-7"})}),e.jsx("h3",{className:"text-lg font-bold text-white",children:"Source Code is Premium Protected"}),e.jsxs("p",{className:"text-xs text-slate-400 leading-relaxed max-w-xs mx-auto",children:["Free users have unlimited access to ",e.jsx("span",{className:"text-emerald-400 font-semibold",children:"run & use all live tools"}),". Inspecting and copying raw source code is reserved for Premium Members."]})]}),e.jsxs("div",{className:"p-4 bg-slate-950/70 rounded-2xl border border-slate-800 space-y-2.5 text-xs",children:[e.jsxs("div",{className:"flex items-center gap-2.5 text-slate-300",children:[e.jsx(P,{className:"w-4 h-4 text-emerald-400 shrink-0"}),e.jsx("span",{children:"Full source code inspection & export"})]}),e.jsxs("div",{className:"flex items-center gap-2.5 text-slate-300",children:[e.jsx(P,{className:"w-4 h-4 text-emerald-400 shrink-0"}),e.jsx("span",{children:"One-click copy & file downloads"})]}),e.jsxs("div",{className:"flex items-center gap-2.5 text-slate-300",children:[e.jsx(P,{className:"w-4 h-4 text-emerald-400 shrink-0"}),e.jsx("span",{children:"Verified Pro Member badge on Profile"})]})]}),e.jsxs("div",{className:"space-y-2 pt-1",children:[n?e.jsxs("div",{className:"space-y-2",children:[e.jsxs("button",{onClick:()=>{a(),s?s("#/profile"):window.location.hash="#/profile"},className:"w-full flex items-center justify-center gap-2 py-3 px-4 bg-gradient-to-r from-amber-500 to-amber-600 hover:from-amber-400 hover:to-amber-500 text-slate-950 font-bold rounded-xl text-xs transition shadow-lg shadow-amber-500/20",children:[e.jsx(Q,{className:"w-4 h-4 fill-current"}),e.jsx("span",{children:"View Profile & Plan Status"}),e.jsx(W,{className:"w-3.5 h-3.5 ml-1"})]}),e.jsx("p",{className:"text-[11px] text-center text-slate-500",children:"To upgrade to Premium, request access from the system administrator."})]}):e.jsx("div",{className:"space-y-2",children:e.jsxs("button",{onClick:()=>{a(),s?s("#/login"):window.location.hash="#/login"},className:"w-full flex items-center justify-center gap-2 py-3 px-4 bg-indigo-600 hover:bg-indigo-500 text-white font-bold rounded-xl text-xs transition shadow-lg shadow-indigo-600/30",children:[e.jsx(We,{className:"w-4 h-4"}),e.jsx("span",{children:"Sign In to Your Account"}),e.jsx(W,{className:"w-3.5 h-3.5 ml-1"})]})}),e.jsx("button",{onClick:a,className:"w-full py-2 text-center text-xs text-slate-400 hover:text-slate-200 transition",children:"Continue Using Live Tool"})]})]})}):null},ot=({code:t})=>{const{showToast:a}=E(),[s,n]=x.useState(!1),[o,r]=x.useState("");let l=null,i=null;try{l=JSON.parse(t)}catch(d){i=d.message||"Invalid JSON syntax"}const m=async()=>{if(!l)return;await de(JSON.stringify(l,null,2))&&(n(!0),a("Formatted JSON copied!","success"),setTimeout(()=>n(!1),2e3))};return e.jsxs("div",{className:"rounded-3xl border border-slate-200/90 dark:border-slate-800 bg-slate-900 overflow-hidden shadow-xl",children:[e.jsxs("div",{className:"flex items-center justify-between px-5 py-3.5 bg-slate-900 border-b border-slate-800 flex-wrap gap-2",children:[e.jsxs("div",{className:"flex items-center gap-2",children:[e.jsx(Ke,{className:"w-4 h-4 text-amber-400"}),e.jsx("span",{className:"text-xs font-bold text-white uppercase tracking-wider",children:"Parsed JSON Data Output"}),i?e.jsx("span",{className:"text-[11px] px-2 py-0.5 rounded bg-rose-950 text-rose-300 border border-rose-800",children:"Invalid Format"}):e.jsx("span",{className:"text-[11px] px-2 py-0.5 rounded bg-emerald-950 text-emerald-300 border border-emerald-800",children:"Valid JSON Object"})]}),e.jsxs("button",{onClick:m,disabled:!!i,className:"flex items-center gap-1.5 px-3 py-1.5 text-xs font-semibold rounded-lg bg-slate-800 hover:bg-slate-700 text-slate-200 border border-slate-700 transition disabled:opacity-50",children:[s?e.jsx($,{className:"w-3.5 h-3.5 text-emerald-400"}):e.jsx(G,{className:"w-3.5 h-3.5"}),e.jsx("span",{children:"Copy Data"})]})]}),e.jsx("div",{className:"p-4 sm:p-6 bg-slate-950 min-h-[350px]",children:i?e.jsxs("div",{className:"p-4 rounded-xl bg-rose-950/50 border border-rose-800 text-rose-300 text-xs space-y-2",children:[e.jsxs("div",{className:"flex items-center gap-2 font-bold",children:[e.jsx(z,{className:"w-4 h-4 text-rose-400"}),e.jsx("span",{children:"JSON Parse Error:"})]}),e.jsx("p",{className:"font-mono",children:i})]}):e.jsx("pre",{className:"text-emerald-400 font-mono text-xs overflow-auto max-h-[500px] leading-relaxed p-4 bg-slate-900/80 rounded-2xl border border-slate-800",children:JSON.stringify(l,null,2)})})]})};function it(t){const a=t.match(/(?:"""|''')([\s\S]*?(?:<!DOCTYPE|<html|<body|<div|<main)[\s\S]*?)(?:"""|''')/i);if(a&&a[1])return a[1].trim();const s=t.match(/(?:html|template|markup)\s*=\s*(?:f?["']{1,3})([\s\S]*?)(?:["']{1,3})/i);return s&&s[1]&&s[1].includes("<")?s[1].trim():null}function dt(t){const a=t.split(`
`),s=[];for(const n of a){const o=n.trim();if(o.startsWith("print(")&&o.endsWith(")")){const r=o.slice(6,-1).trim();r.startsWith("'")&&r.endsWith("'")||r.startsWith('"')&&r.endsWith('"')?s.push(r.slice(1,-1)):s.push(r)}}return s}function ct(t){const a=t.split(`
`),s=new Set;for(const n of a){const o=n.trim(),r=o.match(/^import\s+([a-zA-Z0-9_, ]+)/),l=o.match(/^from\s+([a-zA-Z0-9_]+)\s+import/);r&&r[1]?r[1].split(",").forEach(i=>{const m=i.trim().split(" ")[0];m&&s.add(m)}):l&&l[1]&&s.add(l[1].trim())}return Array.from(s)}function xt(t){const a=t.matchAll(/input\(\s*(?:["'](.*?)["'])?\s*\)/g),s=[];for(const n of a)s.push(n[1]||"Enter value:");return s}function mt(t){return{extractedHtml:it(t),prints:dt(t),imports:ct(t),hasInputs:/input\s*\(/.test(t),inputPrompts:xt(t)}}const pt=`
  body {
...
</html>`}function yt(t,a){const s=JSON.stringify(t);return`<!DOCTYPE html>
<html lang="en">
<head>
  <meta charset="UTF-8">
  <meta name="viewport" content="width=device-width, initial-scale=1.0">
...
</html>`}function vt(t,a){return`<!DOCTYPE html>
<html lang="en">
<head>
  <meta charset="UTF-8">
  <meta name="viewport" content="width=device-width, initial-scale=1.0">
...
</html>`}function Nt(t,a,s){const n=JSON.stringify(t);return`<!DOCTYPE html>
<html lang="en">
<head>
  <meta charset="UTF-8">
  <meta name="viewport" content="width=device-width, initial-scale=1.0">
