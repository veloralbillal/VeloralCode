...
export const Modal: React.FC<ModalProps> = ({
  ...
  return (
    <div className="fixed inset-0 z-50 overflow-y-auto">
      {/* Crisp dark backdrop without blur */}
      <div
        className="fixed inset-0 bg-slate-950/75 transition-opacity animate-in fade-in duration-150"
        onClick={onClose}
      />

      <div className="flex min-h-full items-center justify-center p-4 text-center">
        <div
          className={`relative z-10 w-full ${maxWidthClass} overflow-hidden rounded-2xl bg-white dark:bg-slate-900 p-6 text-left align-middle shadow-2xl border border-slate-200 dark:border-slate-800 transition-opacity animate-in fade-in duration-150`}
        >
