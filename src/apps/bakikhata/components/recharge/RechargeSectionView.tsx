      ...
      <div className="grid grid-cols-1 sm:grid-cols-3 gap-4">
        <div className="p-5 rounded-3xl bg-gradient-to-br from-amber-600 to-amber-700 text-white shadow-lg shadow-amber-600/20">
          ...
          <div className="mt-3">
            ...
            <p className="text-xs text-amber-100 mt-1">{totalCount} টি সফল রিচার্জ</p>
          </div>
        </div>
        ...
        <div className="p-5 rounded-3xl bg-gradient-to-br from-emerald-600 to-teal-700 text-white shadow-lg shadow-emerald-600/20">
          ...
          <div className="mt-3">
            ...
            <p className="text-xs text-emerald-100 mt-1">স্বয়ংক্রিয় কমিশন হিসাব</p>
          </div>
        </div>
        ...
        <div className="flex items-center justify-between">
          <div>
            <h3 className="text-base font-black text-slate-900 dark:text-white">
              মোবাইল রিচার্জ খতিয়ান ও লাভ
            </h3>
            <p className="text-xs text-slate-500">সকল অপারেটরের রিচার্জ ও কমিশন হিসেব</p>
          </div>
          <button
